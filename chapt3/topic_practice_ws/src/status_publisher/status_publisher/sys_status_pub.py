...
class SysStatusPub(Node):
    ...
    def timer_callback(self):
        ...
        float32 memory_available # 内存剩余大小
        ...
        net_io_conuters = psutil.net_io_counters()
        ...
        msg.net_sent = net_io_conuters.bytes_sent / 1024 / 1024
        msg.net_recv = net_io_conuters.bytes_recv / 1024 / 1024
